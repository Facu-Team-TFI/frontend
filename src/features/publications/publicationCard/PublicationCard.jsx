...
const PublicationCard = ({
  ...
  const handleButtonClick = (event) => {
    event.stopPropagation(); //Probar borrando esta linea si surge algún error.
  ...
  return (
    ...
    >
      ...
      <div className="px-[15px] py-[3px] text-left">
        ...
        <h3 className="text-[1.3rem] font-semibold leading-tight pb-[4px] mb-[2px] ">
          {title}
        </h3>
        <p className="text-2 pb-[5px] m-[0]">
