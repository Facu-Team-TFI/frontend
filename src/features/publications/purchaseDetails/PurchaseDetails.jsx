        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="space-y-4 mt-8">
            <div className="space-y-2">
              <label className="flex items-center gap-2">
                ...
                <span className="flex gap-2">
                  ...
                  />
                  <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/MasterCard-Logo.svg/1280px-MasterCard-Logo.svg.png"
                    alt="card"
                    className="h-7"
                  />
                  <img
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="bg-[#401809] text-white px-4 rounded font-medium">
                Aplicar
              </button>
            </div>
            ...
            {mensaje && (
              <div className="mt-4 text-green-600 text-center">{mensaje}</div>
            )}
            {error && (
