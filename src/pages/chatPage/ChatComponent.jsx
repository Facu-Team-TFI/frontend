        ...
        <div className="flex-1 p-4 overflow-y-auto max-h-[540px]">
          {chatlist
            .filter((chat) => {
              ...
              const fullName =
                `${otherUser?.BuyersName || ""} ${otherUser?.BuyersLastName || ""}`.toLowerCase();
            ...
            .map((chat, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`flex items-center p-3 border-b border-[#40250D] cursor-pointer hover:bg-[#60250D] ${
                    String(activeChat) === String(chat.ID_Chat)
                      ? "bg-[#60250D]"
                      : ""
                  }`}
        ...
        <div className="p-4 border-b border-[#40250D] bg-[#60250D] bg-opacity-10 flex items-center">
          {(() => {
            ...
            return (
              <>
                <div
                  className="flex-shrink-0 h-10 w-10 rounded-full bg-[#40250D] flex items-center justify-center text-white overflow-hidden cursor-pointer"
                ...
                <div className="ml-3">
                  ...
                  >
                    {otherUser
                      ? `${otherUser.BuyersName} ${otherUser.BuyersLastName}`
                      : "Usuario"}
                  </h3>
        ...
        >
          {conversations[activeChat]?.map((msg, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${isSender ? "bg-[#60250D] text-white" : "bg-white text-[#40250D]"}`}
                >
